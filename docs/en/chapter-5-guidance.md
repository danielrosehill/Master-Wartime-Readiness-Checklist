...
!!! danger "Warning"
    UAV infiltration uses the **same siren** and follows the **same shelter procedure** as rocket/missile attacks. Enter shelter immediately. Stay for 10 minutes or until the all-clear — whichever comes later.
...
!!! tip "Reminder"
    UAV alerts follow the **same shelter procedure** as rocket/missile alerts. Stay for 10 minutes or until the all-clear — whichever comes later.
